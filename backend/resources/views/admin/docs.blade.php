...
GET       /api/v1/admin/audit-logs</pre>
        ...
        <div class="doc-card rounded-xl p-4 text-sm text-slate-700">
            ...
            <p class="mt-2">A new endpoint enrolls through <code>POST /api/v1/device/enroll</code>, checks in through <code>POST /api/v1/device/checkin</code>, uploads behavior telemetry through <code>POST /api/v1/device/behavior-log</code>, acknowledges work through <code>POST /api/v1/device/job-ack</code>, then reports the final result through <code>POST /api/v1/device/job-result</code>.</p>
        </div>
    </section>
...
backend/resources/views/admin/docs.blade.php</pre>
    </section>
</x-admin-layout>
